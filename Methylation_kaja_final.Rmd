...
```{r fig=TRUE,fig.width=9, fig.height=7, echo=FALSE, include=TRUE, results='asis' }
gseaGo_devel_plot
```
...
* there was a total of `r total_luad1` unique genes from the LUAD set. 
  ...
  + of these `r nrow ( notinkaja_luad )` was not found in the original TSG list
    - this includes the p16 ( CDKN2A ) the reviewer was adamant about
